...
const FormBox = () => {
    ...
    const handleSubmit = () => {
        try {
            setErr('');
            const link = document.getElementById("link-field").value //to be passed to backend
            if(
    ...
    return (
        <Container className="py-5">
            <div className="px-5 rounded-5" id="form-box">
                ...
                <Input id="trigger" type="number" placeholder="Enter the number of times you need the email trigger" className="field-place" min={"1"} />
